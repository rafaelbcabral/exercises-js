...
/* Dobrar valores
   ...
   const rockets = [
     { country: "Russia", lancamentos: 1 },
     { country: "US", lancamentos: 1 },
     { country: "China", lancamentos: 1 },
     { country: "Europe", lancamentos: 1 },
     { country: "India", lancamentos: 1 },
     { country: "Japan", lancamentos: 5 }
   ]
   
   const totalancamentos = rockets.reduce( ( valorAnterior, valorAtual ) => valorAnterior + valorAtual.lancamentos, 
   /*comeca(0 + 32 + 23...) */0)
